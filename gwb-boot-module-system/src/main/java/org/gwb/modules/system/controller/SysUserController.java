...
import org.gwb.common.aspect.annotation.PermissionData;
import org.gwb.common.constant.CommonConstant;
import org.gwb.common.system.api.ISysBaseAPI;
...
import org.gwb.common.util.PasswordUtil;
import org.gwb.common.util.PmsUtil;
import org.gwb.common.util.RedisUtil;
import org.gwb.common.util.oConvertUtils;
import org.gwb.modules.system.entity.*;
import org.gwb.modules.system.model.DepartIdModel;
import org.gwb.modules.system.model.SysUserSysDepartModel;
import org.gwb.modules.system.service.*;
import org.gwb.modules.system.vo.SysDepartUsersVO;
import org.gwb.modules.system.vo.SysUserRoleVO;
...
public class SysUserController {
    ...
    public Result<?> queryByOrgCodeForAddressList(@RequestParam(name = "pageNo", defaultValue = "1") Integer pageNo,
            @RequestParam(name = "pageSize", defaultValue = "10") Integer pageSize,
            @RequestParam(name = "orgCode", required = false) String orgCode, SysUser userParams) {
    ...
    public Result<?> getUserInfo(HttpServletRequest request) {
        ...
        return Result.ok(this.sysUserService.gerUserInfo(username));
    }
