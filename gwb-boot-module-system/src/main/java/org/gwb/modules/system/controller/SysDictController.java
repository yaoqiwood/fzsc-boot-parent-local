package org.gwb.modules.system.controller;
...
import org.gwb.common.constant.CacheConstant;
import org.gwb.common.constant.CommonConstant;
import org.gwb.common.system.query.QueryGenerator;
import org.gwb.common.system.vo.DictModel;
import org.gwb.common.system.vo.DictQuery;
import org.gwb.common.system.vo.LoginUser;
import org.gwb.common.util.ImportExcelUtil;
import org.gwb.common.util.SqlInjectionUtil;
import org.gwb.common.util.oConvertUtils;
import org.gwb.modules.system.entity.SysDict;
import org.gwb.modules.system.entity.SysDictItem;
import org.gwb.modules.system.model.SysDictTree;
import org.gwb.modules.system.model.TreeSelectModel;
import org.gwb.modules.system.service.ISysDictItemService;
import org.gwb.modules.system.service.ISysDictService;
import org.gwb.modules.system.vo.SysDictPage;
...
public class SysDictController {
    ...
    public Result<List<DictModel>> loadDict(@PathVariable String dictCode,
            @RequestParam(name = "keyword") String keyword, @RequestParam(value = "sign", required = false) String sign,
    ...
    public Result<List<String>> loadDictItem(@PathVariable String dictCode, @RequestParam(name = "key") String key,
        ...
        try {
            if (dictCode.indexOf(",") != -1) {
                ...
                List<String> texts = sysDictService.queryTableDictByKeys(params[0], params[1], params[2],
                        key.split(","));
    ...
    public Result<List<TreeSelectModel>> loadTreeData(@RequestParam(name = "pid") String pid,
            @RequestParam(name = "pidField") String pidField, @RequestParam(name = "tableName") String tbname,
        ...
        List<TreeSelectModel> ls = sysDictService.queryTreeList(query, tbname, text, code, pidField, pid,
                hasChildField);
        result.setSuccess(true);
        result.setResult(ls);
        return result;
